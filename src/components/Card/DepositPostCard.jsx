...
const DepositPostCard = ({ post, status, onRefresh }) => {
    return (
        <Card
            className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 mb-4 h-auto shadow-md rounded-lg border border-gray-200 hover:shadow-lg transition-shadow duration-300 transform hover:scale-[1.02] ease-in-out ${status === "others-deposits" ? "cursor-pointer" : ""}`}
        >
...
export default DepositPostCard; 